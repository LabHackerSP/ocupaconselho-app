...
if (file_exists($arquivo)) {
	...
	$image = shell_exec('./wkhtmltoimage --quality 100 --crop-w 600 --custom-header "User-Agent" "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:41.0) Gecko/20100101 Firefox/41.0" "'. $base_url . '" ' . $arquivo);
	echo imagejpeg(imagecreatefrompng($arquivo));
}
?>